...
public class cobaTP01 {
    ...
    public static String kirimBarang() {
        ...
        return "Tidak ada barang yang bisa dikirim.";
    }
    ...
    private static double totalHarga(int jumlah, double diskon) {
        ...
        // Pajak 3% hanya ditambahkan setelah proses voucher selesai (Pengeluaran dihitung setelah pajak)
    ...
    private static double hitungDiskonVoucher(String inputVoucher) {
        ...
        if (!inputVoucher.equalsIgnoreCase("skip") && inputVoucher.equals(kodeVoucher)) {
            return hitungDiskon(kodeVoucher); // Kalau skip dan ternyata kode voucher sesuai, hitung diskon
        }
    ...
    public static int hitungDiskon(String kode) {
        ...
        int total = hasil + hitungDiskon(kode.substring(1, kode.length() - 1));
    ...
    public static int cekSeratus(int hasil) {
        ...
        // Hitung hasil perkalian 
        int result = depan * belakang;
        for (int i=1; i < hsl.length()-1;i++) {
            result += Character.getNumericValue(hsl.charAt(i));
        }
    ...
    public static String lacakBarang() {
        ...
        // Jika barang sudah dikirim dan hari sudah berganti, reset status pengiriman
        // validatorJumlahTransaksi = true;
        return "Status pengiriman barang: sending";
    }
    ...
    public static int validasiInputBeliBarang(String pesan) {
        ...
        if (!scanner.hasNextInt()) {
            ...
            return 0; // Kembalikan 0 agar kembali ke menu utama
        }
